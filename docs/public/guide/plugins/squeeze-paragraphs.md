---
title: squeeze-paragraphs
description: Removes empty (whitespace-only) paragraphs, cleaning up residue left behind by other transforms.
---
...
>
> A paragraph with *emphasis* and an image ![icon](https://picsum.photos/16/16) is not empty either.
% Code
> ````markdown
> A paragraph with text.
>
